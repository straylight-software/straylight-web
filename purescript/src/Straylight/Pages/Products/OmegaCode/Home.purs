-- | omega//code Home Page
-- | Native terminal AI coding agent landing page
module Straylight.Pages.Products.OmegaCode.Home 
  ( homePage
  , render
  ) where
  ...
  HH.section
    ...
    [ HH.div
        ...
        , HH.p
            ...
            [ HH.text "Native terminal AI coding agent. Haskell + Brick TUI. io_uring event loop. 509k req/s. SIGIL-native." ]
          
          -- CTAs
        , HH.div
            [ cls [ "flex flex-col sm:flex-row items-center justify-center gap-4" ] ]
            [ primaryButton "/omega/code/pricing" "Join the waitlist"
            , secondaryButton "https://github.com/straylight-software/omega-code" "View source"
            ]
        ...
        , HH.p
            ...
            [ HH.text "Replaces Claude Code, Cursor, Windsurf, Aider, Copilot Workspace" ]
        ]
    ]
  ...
  HH.section
    ...
    [ HH.div
        ...
        , HH.div
            ...
            , featureCard "!" "SIGIL-native"
                "18 Lean4 proofs for protocol semantics. Corrupted parse cannot propagate to your agent."
            , featureCard "++" "Crew orchestration"
                "Parallel competing agents. CoW filesystem isolation via bwrap. Best result wins."
            , featureCard "=" "Full API parity"
                "95 endpoints. Sessions, messages, files, PTY terminals, SSE streaming, sandboxed execution."
            , featureCard "$" "Post-quantum attestation"
                "Every change cryptographically anchored. Hybrid signatures. Continuity kernel."
            ]
        ]
    ]
  ...
  HH.section
    ...
    [ HH.div
        ...
        , HH.div
            ...
            [ HH.table
                ...
                , HH.tbody_
                    ...
                    , comparisonRow "Tool parsing" "SIGIL" "JSON" "JSON" "JSON"
        ...
        , HH.p
            ...
            [ HH.text "Benchmarks on Linux x86_64, 32 cores." ]
        ]
    ]
...
comparisonRow feature us claude cursor aider =
  HH.tr
    ...
    , HH.td [ cls [ "py-3 text-center" ] ] [ cell claude ]
    , HH.td [ cls [ "py-3 text-center" ] ] [ cell cursor ]
    , HH.td [ cls [ "py-3 text-center" ] ] [ cell aider ]
    ]

cell :: forall w i. String -> HH.HTML w i
cell value =
  HH.span
  ...
  HH.section
    ...
    [ HH.div
        ...
        , HH.div
            [ cls [ "flex flex-col sm:flex-row items-center justify-center gap-4" ] ]
            [ primaryButton "/omega/code/pricing" "Join the waitlist"
            , secondaryButton "/omega/code/pricing" "See pricing"
            ]
        ]
    ]
