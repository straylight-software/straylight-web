...
render =
  HH.div
    ...
    [ header
    , quickStart
    , emptyDashboard "sensenet//confirm"
    ]
...
quickStart =
  HH.div
    ...
    [ HH.h3
        ...
        [ HH.text "Quick Start" ]
    , codeBlock
        [ HH.span [ cls [ "text-muted-foreground" ] ] [ HH.text "# Run your pipeline\n" ]
        , HH.span [ cls [ "text-amber-400" ] ] [ HH.text "$ " ]
        , HH.text "confirm run\n\n"
        , HH.span [ cls [ "text-muted-foreground" ] ] [ HH.text "# Run with proof verification\n" ]
        , HH.span [ cls [ "text-amber-400" ] ] [ HH.text "$ " ]
        , HH.text "confirm run --verify"
        ]
    ]
