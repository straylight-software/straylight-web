...
render =
  HH.div
    ...
    [ header
    , quickStart
    , emptyDashboard "sensenet//converge"
    ]
...
quickStart =
  HH.div
    ...
    [ HH.h3
        ...
        [ HH.text "Quick Start" ]
    , codeBlock
        [ HH.span [ cls [ "text-muted-foreground" ] ] [ HH.text "# Converge now\n" ]
        , HH.span [ cls [ "text-purple-400" ] ] [ HH.text "$ " ]
        , HH.text "converge up\n\n"
        , HH.span [ cls [ "text-muted-foreground" ] ] [ HH.text "# Watch for drift\n" ]
        , HH.span [ cls [ "text-purple-400" ] ] [ HH.text "$ " ]
        , HH.text "converge watch"
        ]
    ]
