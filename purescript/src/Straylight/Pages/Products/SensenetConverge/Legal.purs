...
renderPrivacy = HH.div [ cls [ "max-w-[800px] mx-auto px-6 py-12" ] ]
    ...
    , HH.div [ cls [ "prose prose-invert max-w-none space-y-6" ] ]
        ...
        , section "Overview" "sensenet//converge is operated by Straylight Software."
        , section "Infrastructure Data" "sensenet//converge processes infrastructure state. We do not store your cloud credentials - they remain in your environment."
...
renderTerms = HH.div [ cls [ "max-w-[800px] mx-auto px-6 py-12" ] ]
    ...
    , HH.div [ cls [ "prose prose-invert max-w-none space-y-6" ] ]
        [ section "Last updated" "February 2026"
        , section "Service Description" "sensenet//converge provides typed infrastructure-as-code with desired-state convergence."
