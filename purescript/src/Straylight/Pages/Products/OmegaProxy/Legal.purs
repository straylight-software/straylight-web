...
renderPrivacy =
  HH.div
    ...
    , HH.div [ cls [ "prose prose-invert max-w-none space-y-6" ] ]
        ...
        , section "Data Processing" "omega//proxy processes inference requests in transit. Request data is not stored beyond the active session. We log metadata for debugging but not request content."
...
renderTerms =
  HH.div
    ...
    , HH.div [ cls [ "prose prose-invert max-w-none space-y-6" ] ]
        [ section "Last updated" "February 2026"
        , section "Service Description" "omega//proxy provides verified inference proxy with SSE to SIGIL translation."
...
renderContact =
  HH.div
    ...
    , HH.a [ HP.href "mailto:hello@straylight.software", cls [ "text-purple-400 hover:text-purple-300" ] ] 
